...
pub fn asteroid_miner() -> SpacecraftStructure {
    SpacecraftStructure {
        component_placeholders: vec![
            ...
            ComponentPlaceholder::new(ComponentType::RaptorEngine, ivec2(1, -2), Orientation::Up),
            ComponentPlaceholder::new(ComponentType::KineticWeapon, ivec2(0, 1), Orientation::Up),
            ComponentPlaceholder::new(ComponentType::KineticWeapon, ivec2(0, -1), Orientation::Up),
            ComponentPlaceholder::new(ComponentType::KineticWeapon, ivec2(1, 0), Orientation::Up),
            ComponentPlaceholder::new(ComponentType::KineticWeapon, ivec2(-1, 0), Orientation::Up),
        ],
